...
app.get('/contacts/detail/:id', contacts.getItem)
app.post('/contacts/create', contacts.createNew)
app.put('/contacts/update/:id', contacts.updateItem)
app.delete('/contacts/delete/:id', contacts.deleteItem)
